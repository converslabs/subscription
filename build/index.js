...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (root) {
    (0,flowbite__WEBPACK_IMPORTED_MODULE_5__.initFlowbite)(root); // Scoped initialization
  }
});
const modifyCartItemPrice = (defaultValue, extensions, args, validation) => {
  ...
  if (totals.line_total === "0") {
    return `<price/> ${(0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Due Today", "wp_subscription")}`;
  }
  if (sdevs_subscription && sdevs_subscription.type) {
    ...
    return `<price/> / ${sdevs_subscription.time && sdevs_subscription.time > 1 ? " " + sdevs_subscription.time + "-" : ""}${capitalizedType}${paymentInfo}`;
  }
  return defaultValue;
};
const modifySubtotalPriceFormat = (defaultValue, extensions, args, validation) => {
  ...
  if (sdevs_subscription && sdevs_subscription.type) {
    ...
    const maxPayments = parseInt(sdevs_subscription.max_no_payment, 10);
    const paymentInfo = !isNaN(maxPayments) && maxPayments > 0 ? ` x ${maxPayments}` : "";
    return `<price/> ${(0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Every", "wp_subscription")} ${sdevs_subscription.time && sdevs_subscription.time > 1 ? " " + sdevs_subscription.time + "-" : ""}${capitalizedType}${paymentInfo}`;
  }
  return defaultValue;
};
(0,_woocommerce_blocks_checkout__WEBPACK_IMPORTED_MODULE_0__.registerCheckoutFilters)("sdevs-subscription", {
...
const RecurringTotals = ({
  ...
  const currency = (0,_woocommerce_price_format__WEBPACK_IMPORTED_MODULE_4__.getCurrencyFromPriceResponse)(cartTotals);
  if (recurrings.length === 0) {
    return;
  }
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_woocommerce_blocks_checkout__WEBPACK_IMPORTED_MODULE_0__.TotalsItem, {
    className: "wc-block-components-totals-footer-item",
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Recurring totals", "wp_subscription"),
    description: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("div", {
      style: {
        display: "grid"
      },
      children: recurrings.map(recurring => {
        // Capitalize the first letter to match product page display
        ...
        return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)("div", {
          ...
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)("div", {
            ...
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_woocommerce_blocks_components__WEBPACK_IMPORTED_MODULE_1__.FormattedMonetaryAmount, {
              currency: currency,
          ...
          }), recurring.can_user_cancel === "yes" && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.Fragment, {
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("br", {}), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)("small", {
              children: [(0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("You can cancel subscription at any time!", "wp_subscription"), " "]
            })]
          }), recurring.max_no_payment > 0 && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.Fragment, {
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("br", {}), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)("small", {
              children: [(0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("This subscription will be billed for", "wp_subscription"), " ", recurring.max_no_payment, " ", (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("times.", "wp_subscription")]
            })]
          })]
        });
      })
...
const render = () => {
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_woocommerce_blocks_checkout__WEBPACK_IMPORTED_MODULE_0__.ExperimentalOrderMeta, {
    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(RecurringTotals, {})
  });
};
