...
class SubscriptionCancelled extends WC_Email {
	...
	public function __construct() {
		...
		$this->title       = __( 'Subscription cancelled', 'subscription' );
		$this->description = __( 'This email is sent to customer when a subscription canceled.', 'subscription' );
	...
	public function get_default_subject(): string {
		return __( '#{subscription_id} subscription cancelled!', 'subscription' );
	}
