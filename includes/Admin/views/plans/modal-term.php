...
$field_style = 'flex:1 1 auto;min-width:0;';
?>
	...
	<div class="wpsubs-modal__dialog">
		...
		<div class="wpsubs-modal__body">
			...
			<p style="margin-top:0;color:var(--wpsubs-text-muted);font-size:13px;line-height:1.5;">
				<?php esc_html_e( 'Set how often the customer is charged. Trial and expiry are optional.', 'subscription' ); ?>
			</p>
			...
			<div style="<?php echo esc_attr( $group_style ); ?>">
				...
				<div style="display:flex;gap:10px;align-items:stretch;">
					<input type="number" class="wpsubs-input" value="1" min="1" style="max-width:110px;" data-subscrpt-field="billing_frequency" aria-label="<?php esc_attr_e( 'Frequency', 'subscription' ); ?>" />
			...
			<div style="<?php echo esc_attr( $group_style ); ?>">
				...
				<div style="display:flex;gap:10px;align-items:stretch;">
					<input type="number" class="wpsubs-input" value="" min="0" placeholder="<?php esc_attr_e( 'Length', 'subscription' ); ?>" style="max-width:110px;" data-subscrpt-field="free_trial" />
					<div style="<?php echo esc_attr( $field_style ); ?>">
						<?php
						wpsubs_render_adv_select(
							array(
			...
			<div style="<?php echo esc_attr( $group_style ); ?>">
				...
				<input type="number" id="subscrpt-term-expiry" class="wpsubs-input" value="0" min="0" style="max-width:150px;" data-subscrpt-field="billing_length" />
