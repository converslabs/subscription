<?php
/**
 * Add Products modal (Pro). Bulk-attach products to the current plan group:
 * search, multi-select, then attach every selected product to every term.
 *
...
<div class="wpsubs-modal" id="subscrpt-add-product" hidden data-subscrpt-add-product data-group-id="<?php echo esc_attr( $plan['id'] ); ?>">
	...
	<div class="wpsubs-modal__dialog" style="width:min(720px, calc(100vw - 40px));">
		...
		<div class="wpsubs-modal__footer">
			...
			<button type="button" class="wpsubs-btn wpsubs-btn--primary" data-subscrpt-add-product-submit><?php esc_html_e( 'Add Selected', 'subscription' ); ?></button>
		</div>
	</div>
</div>
